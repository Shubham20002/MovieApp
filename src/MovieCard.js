...
class Moviecard extends React.Component {
    render() {
        ...
        // console.log();
        const {title,plot,price,rating,stars,fav,id}=this.props.movies;
        return (
                            ...
                            <div className="star">
                               <img className="stardec"
                                src="https://cdn-icons-png.flaticon.com/128/43/43625.png"
                                 alt="" onClick={()=>this.props.removestar(this.props.movies)}/>

                               <img className="starimg"
                                src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" alt="" />
                                
                               <img className="starinc" 
                               src="https://cdn-icons-png.flaticon.com/128/3524/3524388.png" alt="" onClick={()=>this.props.addstar(this.props.movies)}/>
                               <span>{stars}</span>
                            </div>
